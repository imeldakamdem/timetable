SET ECHO OFF SET MARKUP HTML ON SPOOL ON SPOOL emploi_temps_TIPAM2.HTML 
...
FROM Cours C JOIN Typehoraire T 
...
WHERE ce.specialiteNomSpec='TIPAM' AND cd.classNiveauidNiveau=002 
